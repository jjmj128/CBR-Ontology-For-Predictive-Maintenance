...
public class LevenshteinDistanceDP {
	/**
	 * 
	 * @param str1 first character chain to be compared
	 * @param str2 second character chain to be compared
	 * @return the Levenshtein distance, defined as the number of characters that
	 *         have to be changed (or deleted or added) in one of the chains to
